...
| --- | --- | --- |
| `bash` | false | Execute a command in the shell and return combined stdout/stderr. Use for builds, tests, git, package managers, etc. To search, read, or change files, use atomic_read / atomic_write rather than cat, sed, or >>. |
