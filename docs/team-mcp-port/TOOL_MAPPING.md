...
| leader_sleep | mult_agent_mcp.py:7999 def leader_sleep | leader-lifecycle | — | 废弃 | tmux leader 生命周期产物;新域无对应状态；等价能力由 `leader_wait` 补回（TOOL_MAPPING.md:70 的废弃判断成立，被删的是能力而非字段） |
