...
assert.equal(document.querySelector('[role="status"] .user-error__summary')!.textContent, t("error.auth"));
await click("Show error details");
assert.equal(document.querySelector('[role="status"] .user-error__detail')!.textContent, "authentication failed");
