...
export const DESKTOP_COMMANDS = [
  ...
  "RemoteHosts",
  "RemoteLastWorkspace",
  "RemoteLocateSessionMessageForTab",
...
export interface TranscriptFollowResponse {
...
export interface RecoveryEntryPage {
  items: RecoveryEntryView[];
  nextCursor?: string;
  generation: number;
}

export interface RecoveryEntryView {
  workspaceChoices: RecoveryWorkspaceChoice[];
  id: string;
  title: string;
  format: string;
  reason: string;
...
export interface RecoveryWorkspaceChoice {
  id: string;
  title: string;
}
...
export interface SessionArchitectureDiagnostics {
  ...
  session_headers_total: number;
  workspace_members_total: number;
  ...
  pending_create_recovered: number;
  prune_blocked_persistence: number;
}
...
export interface SessionDraftContextView {
  operation?: SessionDraftSubmissionView | null;
...
export interface SessionDraftSaveRequest {
  draftId: string;
  revision: number;
  contentJson: string;
...
export interface SessionDraftSaveResult {
  draft: SessionDraftView;
  conflict: boolean;
  outcome: string;
}
...
export interface SessionDraftSettings {
  ...
  toolApprovalMode: string;
  goal?: string;
  disabledMcp: Record<string, ServerView>;
  mcpOrder: string[];
}
...
export interface SessionDraftSubmissionRequest {
  ...
  collaborationMode?: string;
  toolApprovalMode?: string;
  workspaceRefs: DraftWorkspaceRef[];
  settings: SessionDraftSettings;
}

export interface SessionDraftSubmissionView {
  requestId?: string;
  revision: number;
  canResume: boolean;
  canEdit: boolean;
...
export interface SessionUpgradeStatus {
  sources: number;
  sessions: number;
  operations: number;
  discovered: number;
...
export interface WorkspacePendingCreate {
  operationId: string;
  workspaceId: string;
  sessionId: string;
  createdAt: number;
...
export interface WorkspaceSnapshot {
  ...
  pendingCreates: WorkspacePendingCreate[];
}
...
export interface MessageFieldPage {
  status: string;
  messageId: string;
  version: number;
  field: string;
...
export interface GeneratedDesktopCommands {
  ...
  CreateSession(arg0: string): Promise<SessionRef>;
  ...
  ListTrashEntries(arg0: string, arg1: string, arg2: number): Promise<TrashEntryPage>;
  ...
  ModelsForDraft(arg0: string): Promise<ModelInfo[]>;
  ...
  PurgeCanonicalSession(arg0: SessionRef): Promise<void>;
  ...
  RemoteLocateSessionMessageForTab(arg0: string, arg1: string, arg2: number): Promise<MessageLocation>;
  ...
  RemoteSessionOpenForTab(arg0: string): Promise<SessionOpenView>;
  ...
  RemoteTranscriptFollowForTab(arg0: string, arg1: FollowRequest): Promise<TranscriptFollowResponse>;
  ...
  RestoreCanonicalSession(arg0: SessionRef): Promise<void>;
  ...
  ResumeDraftSubmission(arg0: string, arg1: number): Promise<SessionDraftSubmissionView>;
  ...
  SaveSessionMarkdownForTab(arg0: string, arg1: string, arg2: string): Promise<void>;
  ...
  SearchFileRefsForTarget(arg0: ComposerTarget, arg1: string): Promise<DirEntry[]>;
  ...
  SetSessionDraftRestoreTarget(arg0: string): Promise<void>;
  ...
  TranscriptFollowForTab(arg0: string, arg1: FollowRequest): Promise<TranscriptFollowResponse>;
